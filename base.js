...
$.getScript("https://cdn.jsdelivr.net/npm/lodash@4.17.20/lodash.min.js", function() {
  let materialIndex = 0;
  let printIndex = 1;
  ...
  function getFormData(formEl){
    ...
    $.map(unindexed_array, function(n, i){
      _.set(indexed_array, n['name'], n['value']);
    });
    indexed_array['materials'] = getMaterials(indexed_array);
